      ...
      <div class="I106_page">
        ...
        <div class="I106_content">
          <van-radio-group v-model="result">
            <van-cell-group>
              <van-cell :title="item.answer" clickable @click="chooseAnswer(item.id)"  v-for="(item, index) in data.values" :key="data.keyName+'_'+index">
                <van-radio slot="right-icon" checked-color="#16a35f" :name="item.id" />
              </van-cell>
            </van-cell-group>
          </van-radio-group>
        </div>
...
<style lang="scss" type="text/scss" scoped>
  ...
  .I106_content {overflow: auto; height: 100%; padding-top: val(42); background-color: #fff
  ;}
  .R106_radio {padding: val(6); border-bottom: 1px solid #eeeeee;}
</style>
