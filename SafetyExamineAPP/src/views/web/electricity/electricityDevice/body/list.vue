...
<template>
  <van-pull-refresh v-model="loading" @refresh="initData()">
    ...
    >
      <ul class="H106_list">
        <li v-for="(item, index) in listData" :key="'enterprise_'+index" @click="jumpPage('electricityDeviceInfo', {equipment_id: item.equipmentId}, {enterpriseName: $route.query.enterpriseName})">
          <div class="E106_listItem">
            <div class="E106_listItemName">{{item.equipmentId}}</div>
