        ...
        <li v-for="(item, index) in listData" :key="'task_'+index">
          <van-swipe-cell>
            <van-button
              ...
              text="删除"
            />
            <div class="H106_itemOuter" @click="jumpPage('accompanyingDetails', {selftaskid: item.id, selftaskassetid: item.selftaskassetid, isCheck: item.inspectstatus!==1?1:0})">
              <div class="H106_item">
              ...
              <div class="H106_item">
                <div class="H106_itemName">{{item.checkobject || '暂未选择检查对象'}}</div>
              ...
              <div class="H106_item">
                <div class="H106_itemDatas">
                  <div class="H106_itemData">
                    <span>任务性质：</span>
                    <span>{{item.taskNatureName}}</span>
                  </div>
                </div>
                <div class="H106_itemDate">{{item.createUserName}}</div>
              </div>
              <div class="H106_item">
                <div class="H106_itemDatas">
                  <div class="H106_itemData">
                    <span>不合格：</span>
                    <span class="H106_itemNumber">{{item.failcount || 0}}</span>
                    <span>合格：</span>
                    <span class="H106_itemNumber H106_itemNumber2">{{item.passcount || 0}}</span>
                  </div>
                </div>
              </div>
            </div>
