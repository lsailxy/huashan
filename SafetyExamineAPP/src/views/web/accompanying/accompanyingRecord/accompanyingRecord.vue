...
<template>
  <div class="I106_page">
    <div class="I106_header">
      ...
      <div class="I106_title">检查记录</div>
      <div class="H106_add"></div>
    </div>
    <div class="I106_content">
      <div>
        <list :listData="listData" @update="updateList" ref="accompanyingRecordList"></list>
      </div>
    </div>
  </div>
</template>
  ...
  methods: {
    ...
    async updateList(currentPage) {
      ...
      if(res && res.status === 10001) {
        ...
        this.$refs.accompanyingRecordList.isAllLoad(res.result.count)
      } else {
        this.$refs.accompanyingRecordList.errorHandle()
      }
    },
