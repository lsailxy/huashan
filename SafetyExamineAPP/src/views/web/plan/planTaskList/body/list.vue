...
<template>
  <van-pull-refresh v-model="loading" @refresh="initData()">
    ...
    >
      <ul class="H106_list">
        <li v-for="(item, index) in listData" :key="'planTask_'+index" @click="jumpPage('taskDetails', { taskid: item.id})">
          <div class="H106_itemOuter">
            ...
            <div class="H106_item">
              <div class="H106_itemDatas">
                ...
                <div class="H106_itemData">
                  <span>未检查企业数量：</span>
                  <span class="H106_itemNumber">{{item.patrolCount}}</span>
                </div>
              </div>
              <div class="H106_itemSign H106_itemSign1">待检查</div>
            </div>
          </div>
        </li>
      </ul>
...
<style lang="scss" type="text/scss" scoped>
    ...
    .H106_itemOuter {padding: val(12) 0;}
